...
const SidebarContent = ({ onGPTSelect, selectedGPT }: { onGPTSelect: any, selectedGPT: any }) => {
...
export const Sidebar = ({ onGPTSelect, selectedGPT, children }: SidebarProps) => {
  return (
    <div className="flex h-[calc(100vh-4rem)]">
      ...
      <div className="hidden lg:flex w-full">
        <ResizablePanelGroup direction="horizontal" className="w-full">
          <ResizablePanel 
            ...
            className="min-w-80"
          >
            <aside className="h-full border-r border-border bg-card/30 backdrop-blur-sm overflow-y-auto">
              <SidebarContent onGPTSelect={onGPTSelect} selectedGPT={selectedGPT} />
            </aside>
          </ResizablePanel>
      ...
      {/* Tablet and Mobile: Fixed Width Sidebar */}
      <div className="lg:hidden flex w-full">
        <aside className="w-80 h-full border-r border-border bg-card/30 backdrop-blur-sm overflow-y-auto">
          <SidebarContent onGPTSelect={onGPTSelect} selectedGPT={selectedGPT} />
        </aside>
        <div className="flex-1">
          {children}
