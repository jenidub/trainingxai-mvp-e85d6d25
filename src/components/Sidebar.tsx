...
export const Sidebar = ({ onGPTSelect, selectedGPT, onInterfaceChange, activeInterface, isDemo = false }: SidebarProps) => {
  ...
  return (
    <aside className="w-80 h-screen sticky top-0 border-r border-border bg-card/30 backdrop-blur-sm overflow-hidden pt-20">
      <div className="p-4 space-y-4 h-full">
        {/* How It Works Section */}
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Target className="h-4 w-4 text-primary" />
            <h2 className="text-base font-semibold text-foreground">The P2S Difference</h2>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs text-foreground mb-0.5">Learn</h3>
                <p className="text-[10px] text-muted-foreground">Talk to interactive agents, get constant drills and scenarios.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs text-foreground mb-0.5">Apply</h3>
                <p className="text-[10px] text-muted-foreground">Test prompts directly in apps inside your Studio.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs text-foreground mb-0.5">Level Up</h3>
                <p className="text-[10px] text-muted-foreground">Earn badges, certificates, portfolio projects, and a take-home agent.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          {/* Home */}
          <Card 
            className={`p-2 border-2 hover:border-primary/40 transition-smooth cursor-pointer group ${
              activeInterface === 'chat' && !selectedGPT ? 'border-primary bg-primary/5' : 'border-primary/20'
            }`}
            onClick={handleHomeClick}
          >
            <div className="flex items-center gap-2">
              <div className="p-1 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-smooth">
                <Home className="h-4 w-4 text-primary" />
              </div>
              <div className="flex-1">
                <h3 className="font-medium text-xs">Home</h3>
                <p className="text-[10px] text-muted-foreground">Welcome & start here</p>
              </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs">Dashboard</h3>
                <p className="text-[10px] text-muted-foreground">Progress & analytics</p>
              </div>
              <ChevronRight className="h-3 w-3 text-muted-foreground group-hover:text-primary transition-smooth" />
            </div>
          </Card>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs">Training Zone</h3>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs">Custom GPTs</h3>
                <p className="text-[10px] text-muted-foreground">Build custom agents</p>
              </div>
              <ChevronRight className="h-3 w-3 text-muted-foreground group-hover:text-primary transition-smooth" />
            </div>
          </Card>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs">Platform GPTs</h3>
                <p className="text-[10px] text-muted-foreground">Practice prompting skills</p>
              </div>
              <ChevronRight className="h-3 w-3 text-muted-foreground group-hover:text-primary transition-smooth" />
            </div>
          </Card>
        ...
        {/* AI Toolbox Section */}
        <div className="space-y-2">
          <h2 className="text-base font-semibold text-foreground">AI Toolbox</h2>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-xs">Prompting Practice Zone</h3>
                <p className="text-[10px] text-muted-foreground">Prompt on top platforms</p>
              </div>
              <ChevronRight className="h-3 w-3 text-muted-foreground group-hover:text-primary transition-smooth" />
            </div>
          </Card>
